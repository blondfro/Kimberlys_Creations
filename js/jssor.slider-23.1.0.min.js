(function (i, g, c, h, e, k, f) {/*! Jssor */
    ...
    var b = i.$Jssor$ = new function () {
        var j = this, yb = /\S+/g, K = 1, ib = 2, lb = 3, kb = 4, ob = 5, L, s = 0, l = 0, t = 0, A = 0, B = 0,
            E = navigator, tb = E.appName, o = E.userAgent, z = g.documentElement, q = parseFloat;
    ...
    var j = i.$JssorSlider$ = function (q, jc) {
        ...
        var rb = o.$BulletNavigatorOptions, X = o.$ArrowNavigatorOptions, bb = o.$ThumbnailNavigatorOptions,
            R = !o.$UISearchMode, z, v = b.$FindChild(q, "slides", R),
            db = b.$FindChild(q, "loading", R) || b.$CreateDiv(g), Mb = b.$FindChild(q, "navigator", R),
            gc = b.$FindChild(q, "arrowleft", R), ec = b.$FindChild(q, "arrowright", R),
            Kb = b.$FindChild(q, "thumbnavigator", R), qc = b.$CssWidth(v), pc = b.$CssHeight(v), W, U = [],
            yc = b.$Children(v);
        ...
        if (r) {
            ...
            var yb = v, B = [], C, P, Hb = b.$Device(), lb = Hb.Ge, G, qb, Nb, tb;
